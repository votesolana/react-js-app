                ...
                <WalletModalProvider>
                    ...
                    <div className="app-container">
                        ...
                        <div className="horizontal-layout">
                            ...
                            <PresidentDisplay imageSrc={bodenImage} isSelected={candidate === 'boden'} totalVotes={boden} presidentTitle={"Kamala Harris"} podiumImageSrc={"/podium1.png"} onClick={() => handleCandidateClick('boden')} />
